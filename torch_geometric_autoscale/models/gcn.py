...
class GCN(ScalableGNN):
    def __init__(self, num_nodes: int, in_channels, hidden_channels: int,
                 ...
                 buffer_size: Optional[int] = None, device=None, **kwargs):
        ...
        if kwargs['pfn']:
            ...
            print(f"[DEBUG] num_nodes: {num_nodes}")

            self.pfn = PFN(num_nodes, num_layers, **PFN_cfg)
            l_start = PFN_cfg['start_from'] # 0 is deepest layer, 0,1,...,num_layers-1
